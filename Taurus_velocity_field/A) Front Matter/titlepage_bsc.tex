...
% -- Title Page
\Title{The velocity structure of the Taurus molecular cloud}
...
\Who{Felix Eppacher} %Make sure you add all your titles! 
% A name exceeding one line can be created using the \WhoTwo command
%\WhoTwo{ FirstName \\ LastName }
\Degree{Bachelor of Science (BSc)}
\Year{August 2026}
\ProgrammeCode{033 661}
\ProgrammeName{Bachelorstudium Astronomie} %Make sure it has the same Name as in the Studienblatt
\Supervisor{Dr. Sebastian Hutschenreuter, MSc}
