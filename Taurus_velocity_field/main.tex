...
\input{B) Chapters/02_Taurus}
\input{B) Chapters/03_Nifty}
\input{B) Chapters/04_Results}
\input{B) Chapters/05_Conclusion}
...
\bibliographystyle{abbrvnat}   % oder mnras, aa, plainnat
