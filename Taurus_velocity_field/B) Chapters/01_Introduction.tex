...
thesis happens within a few hundred parsecs of the Sun, a region so small against these tens of
kiloparsecs that it would barely exceed the symbol marking the Sun in the figure.

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.85\linewidth]{figures/milky_way.jpg}
    \caption{Face-on view of the Milky Way, with the spiral arms, the central bar and the position
        of the Sun in the Orion Spur indicated. Rings mark the distance from the Galactic center in
        light years, spokes the Galactic longitude. The region studied in this thesis lies within a
        few hundred parsecs of the Sun and is thus far smaller than any structure labelled here.
